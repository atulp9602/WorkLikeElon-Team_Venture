...
router.post('/reset-password/:token',checkCredentials,validateProtectedRoute,updatePassword);
router.post('/forgot-password/',checkCredentials,resetPassword);
router.post('/change-password/:token',checkCredentials,validateProtectedRoute,updatePassword);
